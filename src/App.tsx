...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 selection:bg-brand selection:text-white transition-colors duration-300 flex flex-col">
      ...
      {/* Floating Chat Trigger Button on other pages */}
      {!isChatOpen && (
        <button
          onClick={() => {
            setIsChatOpen(true);
          ...
          className="fixed bottom-[90px] right-6 z-50 flex items-center justify-center w-14 h-14 bg-brand hover:bg-brand/90 text-white rounded-full shadow-[0_4px_24px_rgba(179,0,0,0.5)] transition-all duration-300 hover:scale-110 active:scale-95 group cursor-pointer"
        >
          ...
          <span className="absolute inset-0 rounded-full bg-brand/40 animate-ping opacity-75"></span>
      ...
      {isChatOpen && (
        <div className="fixed bottom-[90px] right-6 z-[60] w-[calc(100vw-3rem)] sm:w-[380px] h-[65dvh] sm:h-[550px] max-h-[700px] bg-neutral-950 border border-neutral-800 rounded-xl shadow-2xl flex flex-col overflow-hidden animate-fade-in">
      ...
      {!isChatOpen && (
        <a
          ...
          className="fixed bottom-6 right-6 z-40 flex items-center justify-center w-14 h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-[0_4px_24px_rgba(16,185,129,0.5)] transition-all duration-300 hover:scale-110 active:scale-95 group"
        >
